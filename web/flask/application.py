...
#when delete product option is selected this function is loaded
@app.route("/delete/<int:pro_id>", endpoint='delete')
def delete(pro_id):
    item_to_delete = Product.query.filter_by(pro_id=pro_id).first()
